...
import { SoftwareDevelopmentIcon, FullStackDesignIcon, DatabaseIcon, CloudHostingIcon } from '@/components/ServiceIcons';
...
const services = [
  {
    ...
    description: 'Robust web and app solutions that meet your unique business needs.',
    bgColor: 'bg-gray-200'
  },
  {
    id: 2,
    ...
    description: 'Comprehensive solutions from front-end interfaces to robust back-end systems.',
    bgColor: 'bg-[#fad02c]'
  },
  {
    id: 3,
    ...
    description: 'Scalable, secure, and efficient database solutions to store and manage your data.',
    bgColor: 'bg-gray-200'
  },
  {
    id: 4,
    ...
    description: 'Reliable cloud hosting solutions for secure and scalable infrastructure.',
    bgColor: 'bg-[#fad02c]'
  }
];
...
const testimonials = [
  {
    ...
    logoText: 'Trip Taxi',
    isImage: true,
    quote: 'Working with Sunrise Digital was a game-changer for Trip Taxi. Their UX/UI design expertise brought our vision to life with a sleek, user-friendly app that our customers love. The team\'s professionalism and innovative approach made the entire process seamless.',
  ...
  },
  {
    ...
    logo: '🏢',
    logoText: 'Tech Corp',
    quote: 'Sunrise Digital transformed our digital presence with their comprehensive solutions. From design to development, they delivered excellence at every step. Their team\'s dedication and expertise exceeded our expectations.',
  ...
  },
  {
    ...
    quote: 'The level of professionalism and attention to detail from Sunrise Digital was outstanding. They helped us build a scalable platform that supports our rapid growth. Highly recommended!',
...
export default function Home() {
  ...
  const handleMenuClick = (menuId: string, event?: React.MouseEvent<HTMLAnchorElement>) => {
    if (event) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="px-4 md:px-8 lg:px-[100px] py-6 md:py-8">
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-8 lg:gap-14 flex-1 justify-center">
              <a href="#about-us" onClick={(e) => handleMenuClick('about-us', e)} className="flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
                {activeMenu === 'about-us' && <div className="w-3.5 h-3.5 bg-[#fad02c] rounded-full" />}
                <span className={`text-sm lg:text-base font-['Montserrat'] ${
                  activeMenu === 'about-us' 
              ...
              <a href="#services" onClick={(e) => handleMenuClick('services', e)} className="flex items-center gap-2 text-sm lg:text-base font-['Montserrat'] cursor-pointer hover:text-[#222222] transition-colors" style={{
                fontWeight: activeMenu === 'services' ? 'bold' : 'normal',
                color: activeMenu === 'services' ? '#222222' : '#636363'
              }}>
                {activeMenu === 'services' && <div className="w-3.5 h-3.5 bg-[#fad02c] rounded-full" />}
                Services
              </a>
              <a href="#portfolio" onClick={(e) => handleMenuClick('portfolio', e)} className="flex items-center gap-2 text-sm lg:text-base font-['Montserrat'] cursor-pointer hover:text-[#222222] transition-colors" style={{
                fontWeight: activeMenu === 'portfolio' ? 'bold' : 'normal',
                color: activeMenu === 'portfolio' ? '#222222' : '#636363'
              }}>
                {activeMenu === 'portfolio' && <div className="w-3.5 h-3.5 bg-[#fad02c] rounded-full" />}
                Portfolio
              </a>
            </div>
          ...
          <div className="flex-1 flex flex-col gap-8 md:gap-12">
            ...
            <div className="flex flex-col gap-6 md:gap-8">
              ...
              <p className="text-base md:text-lg text-[#636363] font-normal font-['Montserrat'] leading-relaxed max-w-2xl">
                Empowering Brands Digitally, we craft tailored software, design seamless systems, and deliver innovative digital solutions to fuel your business growth. From branding to optimization, we create unique digital experiences that help your business thrive.
              </p>
            </div>
      ...
      {/* About Us Section */}
      <section id="about-us" className="w-full bg-[#f5f5f5] px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-16">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-20 items-center">
          ...
          <div className="flex-1 flex flex-col gap-6 md:gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[#fad02c] text-xs md:text-sm font-semibold font-['Montserrat'] tracking-widest uppercase">
                About Us
              </span>
            </div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-['Open_Sans'] text-[#222222] leading-tight">
              <span className="text-[#fad02c]">Insight</span> into Sunrise Digital
            </h2>

            {/* Description */}
            <p className="text-base md:text-lg text-[#636363] font-normal font-['Montserrat'] leading-relaxed">
              At Sunrise Digital, we believe in the power of innovation to transform businesses. With a passion for creativity and technology, our team of experts delivers tailored solutions that align with your goals. From startups to enterprises, we have helped countless clients achieve success through dynamic branding, seamless digital experiences, and intelligent automation. Empowering Brands Digitally is at the core of what we do. Let us take your business to new heights.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Services Section */}
      <section id="services" className="w-full bg-white px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-16">
        {/* Section Header */}
        <div className="mb-12 md:mb-16 flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-['Open_Sans'] text-[#222222] leading-tight max-w-3xl">
            Innovative Digital <span className="text-[#fad02c]">Solutions</span> Tailored for Success
          </h2>
        </div>
            ...
            {services.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all ${
                  index === currentServiceIndex ? 'bg-[#fad02c] w-8' : 'bg-gray-300 w-2'
                }`}
      ...
      </section>      {/* Client Success Stories Section */}
      <section className="w-full bg-white px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-16">       {/* Section Header */}
        <div className="mb-12 md:mb-16 flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-['Open_Sans'] text-[#222222] leading-tight max-w-3xl">
          ...
          <div className="flex justify-center gap-2 mt-6">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full transition-all ${
                  index === currentTestimonialIndex ? 'bg-[#fad02c] w-8' : 'bg-gray-300 w-2'
                }`}
      ...
      <section className="w-full bg-[#222222] px-4 md:px-8 lg:px-[100px] py-8 md:py-10 lg:py-14">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex-1 flex flex-col gap-6 md:gap-8">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-['Open_Sans'] text-white leading-tight">
              Ready <span className="text-[#fad02c]">to elevate</span> your Business?
            </h2>
        ...
        {/* Portfolio Section */}
      <section id="portfolio" className="w-full bg-white px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-16">
        {/* Section Header */}
        <div className="mb-12 md:mb-16 flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-['Open_Sans'] text-[#222222] leading-tight max-w-3xl">
          ...
          <p className="text-base md:text-lg text-[#636363] font-normal font-['Montserrat'] leading-relaxed max-w-2xl mt-4">
            From beautifully crafted websites to intelligent automation systems, we're proud to showcase the results of our collaboration with forward-thinking businesses
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
          ...
          <div className="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer">
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">Teacher's Assistant</h3>
              <p className="text-sm md:text-base text-[#636363] font-normal font-['Montserrat']">AI-powered lesson planning and automation</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer">
            ...
            />
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">Guardian Consulting</h3>
              <p className="text-sm md:text-base text-[#636363] font-normal font-['Montserrat']">Safeguarding and consulting website</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer">
            ...
            />
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">TaxiCode Platform</h3>
              <p className="text-sm md:text-base text-[#636363] font-normal font-['Montserrat']">Real-time location and booking platform</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 cursor-pointer">
            ...
            />
            <div className="p-6 md:p-8">
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">Trip Taxi</h3>
              <p className="text-sm md:text-base text-[#636363] font-normal font-['Montserrat']">Full-stack mobile and web application</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="contact-info" className="w-full bg-[#f5f5f5] px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-16">
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-center justify-center">
          ...
          <div className="flex flex-col items-center text-center md:text-left md:items-start gap-4">
            <div className="w-16 h-16 bg-[#fad02c] rounded-full flex items-center justify-center">
              <svg className="w-8 h-8 text-[#222222]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                <rect x="2" y="4" width="20" height="16" rx="2"/>
                <path d="m22 6-10 7L2 6"/>
              </svg>
            </div>
            <div>
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">Email us</h3>
              <p className="text-base md:text-lg text-[#636363] font-normal font-['Montserrat']">hello@sunrisedigital.co.za</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center md:text-left md:items-start gap-4">
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-bold font-['Montserrat'] text-[#222222] mb-2">Phone number</h3>
              <p className="text-base md:text-lg text-[#636363] font-normal font-['Montserrat']">+44 7736 333575</p>
            </div>
          </div>
        </div>
      </section>
